...
| **2** | Fix Node.js Child Process | Phase 1, 1.5 | ✅ Done | Bidirectional JSON-RPC, process pool (4 worker + 2 background), 50+ bridge methods, esbuild TS transpilation, crash recovery, process recycling, 9 TS scripts migrated to new bitcode.* API, 15 tests |
