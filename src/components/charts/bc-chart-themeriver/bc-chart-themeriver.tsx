...
import { ChartClickEvent, ChartHoverEvent, ChartLegendSelectEvent, DataFetcher } from '../../../core/types';
import {
  echarts, ECharts,
...
@Component({ tag: 'bc-chart-themeriver', styleUrl: 'bc-chart-themeriver.css', shadow: false })
export class BcChartThemeriver {
  ...
  componentDidLoad() {
    this.chart = initChart(this.el, this.theme, this.renderer, {
      ...
      lcChartLegendSelect: this.lcChartLegendSelect, lcChartReady: this.lcChartReady,
    });
