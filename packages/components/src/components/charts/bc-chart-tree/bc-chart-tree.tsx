...
@Component({ tag: 'bc-chart-tree', styleUrl: 'bc-chart-tree.css', shadow: false })
export class BcChartTree {
  ...
  @Prop() locale: string = '';
  @Prop() layout: string = 'orthogonal';
  @Prop() orient: string = 'LR';
  ...
  private renderChart() {
    ...
    const hd = parsed as HierarchicalData;
